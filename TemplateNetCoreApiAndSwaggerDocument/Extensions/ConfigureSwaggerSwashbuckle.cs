...
namespace TemplateNetCoreApiAndSwaggerDocument.Extensions
{
    /// <summary>
    ...
    public static class ConfigureSwaggerSwashbuckle
    {
        ...
        {
            //services.AddTransient<IConfigureOptions<SwaggerGenOptions>, ConfigureSwaggerSwashbuckleOptions>(); // sử dụng cho logic version
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                // custom cho swagger chấp nhận param null
